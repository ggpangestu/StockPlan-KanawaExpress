...
<div class="text-[#2c1f16] font-sans">
    ...
    <div class="max-w-7xl mx-auto lg:pl-6">

    <!-- INFO -->
    <div class="bg-white rounded-2xl mb-6 py-3 px-6 shadow-sm mt-4 border border-[#e8e8e5]">
        Bahan baku akan bertahan:
        <span class="font-bold">7 hari (Good)</span>
    </div>
...
<div class="max-w-7xl mx-auto lg:pl-12">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('owner.armada.create') }}"
   class="bg-[#4A3219] hover:bg-[#382613] text-white px-5 py-2 rounded-xl text-sm font-medium transition shadow-sm flex items-center gap-2">
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
    ...
    @forelse($armadas as $armada)
        ...
        <div
            class="bg-white rounded-3xl border border-[#e8e8e5]
    ...
    @empty
        ...
        <div
            class="col-span-full
            bg-white rounded-3xl border border-[#e8e8e5]
